...
class _AddFriendsSheetState extends State<AddFriendsSheet> {
  ...
  Widget _buildUserTile(Map<String, dynamic> user) {
    ...
    final requestStatus = FriendRequestStatus.fromString(
      user['friend_request_status'] as String?,
    );

    Widget trailingWidget;

    if (requestStatus.isSent || false) {
      // Changed isPending to false
      ...
      trailingWidget = TextButton.icon(
        ...
        onPressed: () {
          // Commented out provider call
          // context.read<FriendsProvider>().sendFriendRequest(context, user)
        },
      );
    }
  ...
  Widget _buildContent() {
    // Commented out Consumer and replaced with static UI
    return Center(
      child: Text(
    ...
    // Original Consumer code commented out
